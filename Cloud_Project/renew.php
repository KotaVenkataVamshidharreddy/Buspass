...
<?php
    ...
    if (isset($_POST['id'])) {
        ...
        $updateQuery = mysqli_query($conn, "UPDATE pass SET date = '$new_date' WHERE id = '$id'");
        if (!$updateQuery) {
            die("Error updating date: " . mysqli_error($conn));
        }
    ...
    <div class="container">
      <form action="invoice.php" method="post">
        ...
        <?php
          ...
          // Use the connection in the query
          $priceResult = mysqli_query($conn, "SELECT price FROM destination WHERE name = '$dest'");
          if (!$priceResult) {
              die("Error fetching price: " . mysqli_error($conn));
          }
